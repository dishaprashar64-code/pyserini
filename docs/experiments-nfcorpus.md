...
+ Results reproduced by [@dishaprashar64-code](https://github.com/dishaprashar64-code) on 2026-02-09 (commit [`TEMP`](https://github.com/castorini/pyserini/commit/TEMP))